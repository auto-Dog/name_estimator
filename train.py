...
trainset = CVDImageNet(args.dataset,split='train',patch_size=args.patch,img_size=args.size,cvd=args.cvd)
valset = CVDImageNet(args.dataset,split='val',patch_size=args.patch,img_size=args.size,cvd=args.cvd)
